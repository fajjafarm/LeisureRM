...
'@ | Out-File -Encoding utf8 database\migrations\2024_01_01_000001_create_businesses_table.php

# 2024_01_01_000002_create_facilities_table.php
@'
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
...
'@ | Out-File -Encoding utf8 database\migrations\2024_01_01_000002_create_facilities_table.php

# 2024_01_01_000003_create_sub_facilities_table.php
@'
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
...
'@ | Out-File -Encoding utf8 database\migrations\2024_01_01_000003_create_sub_facilities_table.php

# 2024_01_01_000004_create_users_extended_table.php
@'
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
...
'@ | Out-File -Encoding utf8 database\migrations\2024_01_01_000004_create_user_profiles_table.php

Write-Host "02 - Core tenancy & user migrations created (businesses, facilities, sub_facilities, user_profiles)"